...
curl -s https://raw.githubusercontent.com/radtriste/kogito-pipelines/kogito-8502-quarkus-integration-job/dsl/seed/scripts/setup_integration_branch.sh | bash